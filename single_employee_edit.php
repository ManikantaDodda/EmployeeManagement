                  ...
                  <div class="panel-body">
                     <form action="" method="POST">
                        ...
                        <div class="form-group">
                           <input type="text" class="form-control input-sm" name="e_name" value= "<?php echo $employee['e_name'];?>" placeholder="Employee Name" required>
                        </div>
                        <div class="form-group">
                           <input type="email" class="form-control input-sm" name="e_email" value= "<?php echo $employee['e_email'];?>" placeholder="Employee Email" required>
                        </div>
                        <div class="form-group">
                           <input type="tel" class="form-control input-sm" name = "e_phone" value= "<?php echo $employee['e_phone'];?>" placeholder="Employee Phone Number" required>
                        </div>
                        <div class="form-group">
